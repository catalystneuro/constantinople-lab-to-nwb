...
def add_optogenetics_series(nwbfile: NWBFile, metadata: dict):
    ...
    if nwbfile.trials is None:
        raise ValueError("No trials found in the NWB file. Please add trials before adding optogenetics series.")

    # Add optogenetics data to the NWB file
    trials = nwbfile.trials[:]
    # TODO: confirm that this is the correct way to filter opto trials
